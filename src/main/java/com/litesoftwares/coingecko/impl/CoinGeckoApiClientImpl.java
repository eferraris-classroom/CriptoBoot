...
public class CoinGeckoApiClientImpl implements CoinGeckoApiClient {
    ...
    @Override
    public Double getPrice(String ids, String vsCurrencies){
        return getPrice(ids, vsCurrencies, false, false, false,  false).get(ids).get(vsCurrencies);
    }
    ...
    @Override
    public List<CoinMarkets> getCoinMarkets(String usd, String vsCurrency) {
